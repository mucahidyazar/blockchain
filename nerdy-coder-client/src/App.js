...
function App() {
  ...
  const claimNFTs = _amount => {
    ...
    blockchain.smartContract.methods
      ...
      .send({
        gasLimit: '285000', // Bu gas limiti metamaskin gas limitini duzgun bir sekilde ayarlayabilmesi ve transactionlari basarisiz olmadan yapabilmesi icin kullanilir.
